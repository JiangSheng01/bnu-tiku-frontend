<template>
  <div class="question-card">
    <a-col
      ...
      :key="'search-' + q.question_id + '-' + pageType"
    >
      <a-card
      ...
      >
        ...
        <div class="actions">
          ...
          <a-button
            ...
            @click="
              // requireLogin(() => {
              //   // if (router.currentRoute.value.path.includes('keyword')) {
              //   //   router.push({
              //   //     path: `/search/question/by/keyword?kw=有理数`,
              //   //     query: { redirect: '/search/question/by/keyword' },
              //   //   });
              //   // } else {
              //   //   router.push({
              //   //     path: '/search/question/by/kp',
...
import { getQuestionsByIds } from "@/api/question";
...
function toggleBasket(q: any) {
  if (questionBasket.value.has(q.question_id)) {
    ...
    questionBasket.value.set(q.question_id, q.question_id); // O(1)
